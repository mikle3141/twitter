...
--changeset SergeyLabuzov:cereate-twitter-tweets-table
...
--changeset SergeyLabuzov:add-twitter-tweets-table-constraints
...
--changeset SergeyLabuzov:add-twiiter-user_profiles-table-column-modified_timestamp
--comment add column modified_timestamp to twitter.tweets table
alter table twitter.tweets
    add column modified_timestamp timestamp;

update twitter.tweets set modified_timestamp = create_timestamp
